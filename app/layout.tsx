...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${baseUrl}/og?title=${encodeURIComponent('Michelangelo Granato')}`,
        width: 1200,
        height: 630,
        alt: 'Michelangelo Granato - Portfolio',
      },
    ],
  },
  twitter: {
    ...
    title: 'Michelangelo Granato - Portfolio',
    description: 'Full-stack development, selected projects, photography, and writing by Michelangelo Granato.',
    images: [`${baseUrl}/og?title=${encodeURIComponent('Michelangelo Granato')}`],
  },
  robots: {
    index: true,
    follow: true,
